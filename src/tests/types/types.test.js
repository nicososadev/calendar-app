...
export const defaultTypes = {
    ...
    eventCreateManager: '[Event] Create Event Manager',
    eventRead: '[Event] Read Events',
    eventUpdate: '[Event] Update Event',
    eventDelete: '[Event] Delete Event',
    eventSetActive: '[Event] Set Active',
    cleanActiveEvent: '[Event] Clean Active Event',
    cleanCalendar: '[Event] Clean Calendar Logout ',
...
describe('Pruebas en types', () => {
    ...
    test('Debe estar definido correctamente', () => {
